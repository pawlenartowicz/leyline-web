...
your distro and copy its block. These are pinned to **v0.3.1**; on arm64 swap
...
must all be `0.3.*`. A `0.3` engine on `0.2` themes won't render. See the
...
```sh
cd /tmp && curl -fsSL -O https://github.com/pawlenartowicz/leyline/releases/download/v0.3.1/leyline-server_0.3.1_amd64.rpm -O https://github.com/pawlenartowicz/leyline/releases/download/v0.3.1/leyline-web_0.3.1_amd64.rpm
sudo dnf install ./leyline-server_0.3.1_amd64.rpm ./leyline-web_0.3.1_amd64.rpm
```

**Debian / Ubuntu:**

```sh
cd /tmp && curl -fsSL -O https://github.com/pawlenartowicz/leyline/releases/download/v0.3.1/leyline-server_0.3.1_amd64.deb -O https://github.com/pawlenartowicz/leyline/releases/download/v0.3.1/leyline-web_0.3.1_amd64.deb
sudo apt install ./leyline-server_0.3.1_amd64.deb ./leyline-web_0.3.1_amd64.deb
```

**Alpine:**

```sh
cd /tmp && curl -fsSL -O https://github.com/pawlenartowicz/leyline/releases/download/v0.3.1/leyline-server_0.3.1_amd64.apk -O https://github.com/pawlenartowicz/leyline/releases/download/v0.3.1/leyline-web_0.3.1_amd64.apk
sudo apk add --allow-untrusted ./leyline-server_0.3.1_amd64.apk ./leyline-web_0.3.1_amd64.apk
```
