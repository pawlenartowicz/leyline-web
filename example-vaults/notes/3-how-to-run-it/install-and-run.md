...
your distro and copy its block. These pull the **latest** release; on arm64 swap
...
must all share one minor. A newer engine on older themes won't render. See the
...
```sh
cd /tmp && curl -fsSL -O https://github.com/pawlenartowicz/leyline/releases/latest/download/leyline-server_amd64.rpm -O https://github.com/pawlenartowicz/leyline/releases/latest/download/leyline-web_amd64.rpm
sudo dnf install ./leyline-server_amd64.rpm ./leyline-web_amd64.rpm
```

**Debian / Ubuntu:**

```sh
cd /tmp && curl -fsSL -O https://github.com/pawlenartowicz/leyline/releases/latest/download/leyline-server_amd64.deb -O https://github.com/pawlenartowicz/leyline/releases/latest/download/leyline-web_amd64.deb
sudo apt install ./leyline-server_amd64.deb ./leyline-web_amd64.deb
```

**Alpine:**

```sh
cd /tmp && curl -fsSL -O https://github.com/pawlenartowicz/leyline/releases/latest/download/leyline-server_amd64.apk -O https://github.com/pawlenartowicz/leyline/releases/latest/download/leyline-web_amd64.apk
sudo apk add --allow-untrusted ./leyline-server_amd64.apk ./leyline-web_amd64.apk
```
